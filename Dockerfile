...
RUN curl -L https://archive.raspberrypi.org/debian/raspberrypi.gpg.key | apt-key add -
...
RUN wget https://github.com/pooler/electrum-ltc/archive/2.9.3.1.tar.gz
RUN pip2 install ./2.9.3.1.tar.gz
...
# etherium vanitygen
RUN curl -LO https://github.com/Limeth/ethaddrgen/releases/download/v1.0.5/ethaddrgen-v1.0.5-armv7-unknown-linux-gnueabihf.tar.gz
RUN tar xf ethaddrgen-v1.0.5-armv7-unknown-linux-gnueabihf.tar.gz
